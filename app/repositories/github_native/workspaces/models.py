...
class Workspace(Base):
    ...
    __table_args__ = (UniqueConstraint("candidate_session_id", "task_id", name="uq_workspaces_session_task"),)
    ...
    last_test_summary_json: Mapped[str | None] = mapped_column(String, nullable=True)  # JSON string with counts/output
